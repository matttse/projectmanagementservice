...
module.exports = {
  ...
  output: {
    path: path.join(__dirname, 'projectmanagementservice', 'static', 'build'),
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'projectmanagementservice', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
    }),
  ].concat(debug ? [] : [
